<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="id_number" name="id_number" type="number" class="mt-1 block w-full" :value="old('id_number', $user->id_number)" required autofocus autocomplete="id_number" />
        ...
        @if (!Auth::user()->is_admin)
            ...
            <div>
                ...
                <x-text-input id="grade_level" name="grade_level" type="text" class="mt-1 block w-full" :value="old('grade_level', $user->grade_level)" required autofocus autocomplete="grade_level" />
