            ...
            <form action="{{ route('updateBook.update', ['id' => $book->id]) }}" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column;">
                ...
                <div class="form" style="">
                  <div class="fields">
                    ...
                    <input class="input"  type="text" id="title" name="title" required style="background-color: transparent; border: 0; border-bottom: 2px solid white" value="{{ $book->title }}">
                    <br> <br>
                    <label for="author"><b>Author</b></label> <br>
                    <input class="input"  type="text" id="author" name="author" required style="background-color: transparent; border: 0; border-bottom: 2px solid white" value="{{ $book->author }}">
                    <br> <br>
                    <label for="subject"><b>Subject</b></label> <br>
                    <input class="input"  type="text" id="subject" name="subject" required style="background-color: transparent; border: 0; border-bottom: 2px solid white" value="{{ $book->subject }}">
                    <br> <br>
                    <label for="availability"><b>Availability</b></label> <br>
                    <input {{ $book->availability == 'Available' ? 'checked' : '' }} type="radio" id="availability" name="availability" value="Available" style="background-color: transparent; border:1px solid white"> Available &nbsp;
                    <input {{ $book->availability == 'Not Available' ? 'checked' : '' }} type="radio" id="availability" name="availability" value="Not Available" style="background-color: transparent; border:1px solid white"> Not Available
                    <br> <br>
                    <label for="isbn"><b>ISBN</b></label> <br>
                    <input class="input"  type="text" id="isbn" name="isbn" required style="background-color: transparent; border: 0; border-bottom: 2px solid white" value="{{ $book->isbn }}">
                    <br> <br>
                  </div>
                  ...
                  <div style="position: relative;">
                    ...
                    <input class="imgInput" type="file" id="image" name="image" accept="image/*" style="box-shadow: 0px 20px 15px 5px rgba(0, 0, 0, 0.306); color:transparent; background-color: rgb(38, 117, 122); cursor: pointer; text-align: right; border-radius: 5px; height: 435px; width: 320px;">
                    @if ($book->image)
                        <img id="previewImage" src="{{ asset('storage/' . $book->image) }}" alt="Current Image" style="display: block;">
                    @else
                ...
                <button class="addBtn" type="submit" ><b>Update Book</b></button>
                <br>
